...
export default function SareeDetailError({
  error,
  reset,
}: {
  ...
  return (
    <Container className="flex min-h-[50vh] flex-col items-center justify-center py-20 text-center">
      <h1 className="text-chapter text-ink">We couldn&apos;t load this saree</h1>
      <p className="mt-4 text-text-muted">Please try again, or browse the full collection.</p>
